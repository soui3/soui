...
namespace luatinker
{
    ...
    template<typename RVal, typename T1 = void, typename T2 = void, typename T3 = void, typename T4 = void, typename T5 = void>
        struct functor
        {
			...
			static int invokeU( lua_State *L )
			{
				push( L, upvalue_<RVal(UAPI *)( T1, T2, T3, T4, T5 )>( L )( read<T1>( L, 1 ), read<T2>( L, 2 ), read<T3>( L, 3 ), read<T4>( L, 4 ), read<T5>( L, 5 ) ) );
				return 1;
			}
    ...
    template<typename RVal, typename T1, typename T2, typename T3, typename T4>
        struct functor < RVal, T1, T2, T3, T4 >
        {
			...
			static int invokeU( lua_State *L )
			{
				push( L, upvalue_<RVal(UAPI *)( T1, T2, T3, T4 )>( L )( read<T1>( L, 1 ), read<T2>( L, 2 ), read<T3>( L, 3 ), read<T4>( L, 4 ) ) );
				return 1;
			}
        };
    ...
    template<typename RVal, typename T1, typename T2, typename T3>
        struct functor < RVal, T1, T2, T3 >
        {
			...
			static int invokeU( lua_State *L )
			{
				push( L, upvalue_<RVal(UAPI *)( T1, T2, T3 )>( L )( read<T1>( L, 1 ), read<T2>( L, 2 ), read<T3>( L, 3 ) ) );
				return 1;
			}
        };
    ...
    template<typename RVal, typename T1, typename T2>
        struct functor < RVal, T1, T2 >
        {
			...
			static int invokeU( lua_State *L )
			{
				push( L, upvalue_<RVal(UAPI *)( T1, T2 )>( L )( read<T1>( L, 1 ), read<T2>( L, 2 ) ) );
				return 1;
			}
        };
    ...
    template<typename RVal, typename T1>
        struct functor < RVal, T1 >
        {
			...
			static int invokeU( lua_State *L )
			{
				push( L, upvalue_<RVal(UAPI *)( T1 )>( L )( read<T1>( L, 1 ) ) );
				return 1;
			}
        };
    ...
    template<typename T1, typename T2, typename T3, typename T4, typename T5>
        struct functor < void, T1, T2, T3, T4, T5 >
        {
			...
			static int invokeU( lua_State *L )
			{
				upvalue_<void(UAPI *)( T1, T2, T3, T4, T5 )>( L )( read<T1>( L, 1 ), read<T2>( L, 2 ), read<T3>( L, 3 ), read<T4>( L, 4 ), read<T5>( L, 5 ) );
				return 0;
			}
        };
    ...
    template<typename T1, typename T2, typename T3, typename T4>
        struct functor < void, T1, T2, T3, T4 >
        {
			...
			static int invokeU( lua_State *L )
			{
				upvalue_<void(UAPI *)( T1, T2, T3, T4 )>( L )( read<T1>( L, 1 ), read<T2>( L, 2 ), read<T3>( L, 3 ), read<T4>( L, 4 ) );
				return 0;
			}
        };
    ...
    template<typename T1, typename T2, typename T3>
        struct functor < void, T1, T2, T3 >
        {
			...
			static int invokeU( lua_State *L )
			{
				upvalue_<void(UAPI *)( T1, T2, T3 )>( L )( read<T1>( L, 1 ), read<T2>( L, 2 ), read<T3>( L, 3 ) );
				return 0;
			}
        };
    ...
    template<typename T1, typename T2>
        struct functor < void, T1, T2 >
        {
			...
			static int invokeU( lua_State *L )
			{
				upvalue_<void(UAPI *)( T1, T2 )>( L )( read<T1>( L, 1 ), read<T2>( L, 2 ) );
				return 0;
			}
        };
    ...
    template<typename T1>
        struct functor < void, T1 >
        {
			...
			static int invokeU( lua_State *L )
			{
				upvalue_<void(UAPI *)( T1 )>( L )( read<T1>( L, 1 ) );
				return 0;
			}
        };
    ...
    template<typename T1>
        struct functor < int, lua_State*, T1 >
        {
			...
			static int invokeU( lua_State *L )
			{
				return upvalue_<int(UAPI *)( lua_State*, T1 )>( L )( L, read<T1>( L, 1 ) );
			}
        };
    ...
    template<>
        struct functor < int, lua_State* >
        {
			...
			static int invokeU( lua_State *L )
			{
				return upvalue_<int(UAPI *)( lua_State* )>( L )( L );
			}
        };
    ...
    template<typename RVal, typename T, typename T1 = void, typename T2 = void, typename T3 = void, typename T4 = void, typename T5 = void>
        struct mem_functor
        {
			...
			static int invokeU( lua_State *L )
			{
				push( L,( read<T*>( L, 1 )->*upvalue_<RVal(UAPI T::* )( T1, T2, T3, T4, T5 )>( L ) )( read<T1>( L, 2 ), read<T2>( L, 3 ), read<T3>( L, 4 ), read<T4>( L, 5 ), read<T5>( L, 6 ) ) );;
				return 1;
			}
        };
    ...
    template<typename RVal, typename T, typename T1, typename T2, typename T3, typename T4>
        struct mem_functor < RVal, T, T1, T2, T3, T4 >
        {
			...
			static int invokeU( lua_State *L )
			{
				push( L,( read<T*>( L, 1 )->*upvalue_<RVal(UAPI T::* )( T1, T2, T3, T4 )>( L ) )( read<T1>( L, 2 ), read<T2>( L, 3 ), read<T3>( L, 4 ), read<T4>( L, 5 ) ) );
				return 1;
			}
        };
    ...
    template<typename RVal, typename T, typename T1, typename T2, typename T3>
        struct mem_functor < RVal, T, T1, T2, T3 >
        {
			...
			static int invokeU( lua_State *L )
			{
				push( L,( read<T*>( L, 1 )->*upvalue_<RVal(UAPI T::* )( T1, T2, T3 )>( L ) )( read<T1>( L, 2 ), read<T2>( L, 3 ), read<T3>( L, 4 ) ) );
				return 1;
			}
        };
    ...
    template<typename RVal, typename T, typename T1, typename T2>
        struct mem_functor < RVal, T, T1, T2 >
        {
			...
			static int invokeU( lua_State *L )
			{
				push( L,( read<T*>( L, 1 )->*upvalue_<RVal(UAPI T::* )( T1, T2 )>( L ) )( read<T1>( L, 2 ), read<T2>( L, 3 ) ) );
				return 1;
			}
		...
		struct mem_functor < RVal, T, T1 >
		{
			...
			static int invokeU( lua_State *L )
			{
				push( L,( read<T*>( L, 1 )->*upvalue_<RVal(UAPI T::* )( T1 )>( L ) )( read<T1>( L, 2 ) ) );
				return 1;
			}
		};
        ...
        struct mem_functor < RVal, T >
        {
			...
			static int invokeU( lua_State *L )
			{
				push( L,( read<T*>( L, 1 )->*upvalue_<RVal(UAPI T::* )( )>( L ) )( ) );
				return 1;
			}
        };
        ...
        struct mem_functor < void, T, T1, T2, T3, T4, T5 >
        {
			...
			static int invokeU( lua_State *L )
			{
				( read<T*>( L, 1 )->*upvalue_<void(UAPI T::* )( T1, T2, T3, T4, T5 )>( L ) )( read<T1>( L, 2 ), read<T2>( L, 3 ), read<T3>( L, 4 ), read<T4>( L, 5 ), read<T5>( L, 6 ) );
				return 0;
			}
        };
    ...
    template<typename T, typename T1, typename T2, typename T3, typename T4>
        struct mem_functor < void, T, T1, T2, T3, T4 >
        {
			...
			static int invokeU( lua_State *L )
			{
				( read<T*>( L, 1 )->*upvalue_<void(UAPI T::* )( T1, T2, T3, T4 )>( L ) )( read<T1>( L, 2 ), read<T2>( L, 3 ), read<T3>( L, 4 ), read<T4>( L, 5 ) );
				return 0;
			}
        };
    ...
    template<typename T, typename T1, typename T2, typename T3>
        struct mem_functor < void, T, T1, T2, T3 >
        {
			...
			static int invokeU( lua_State *L )
			{
				( read<T*>( L, 1 )->*upvalue_<void(UAPI T::* )( T1, T2, T3 )>( L ) )( read<T1>( L, 2 ), read<T2>( L, 3 ), read<T3>( L, 4 ) );
				return 0;
			}
        };
    ...
    template<typename T, typename T1, typename T2>
        struct mem_functor < void, T, T1, T2 >
        {
			...
			static int invokeU( lua_State *L )
			{
				( read<T*>( L, 1 )->*upvalue_<void(UAPI T::* )( T1, T2 )>( L ) )( read<T1>( L, 2 ), read<T2>( L, 3 ) );
				return 0;
			}
        };
    ...
    template<typename T, typename T1>
        struct mem_functor < void, T, T1 >
        {
			...
			static int invokeU( lua_State *L )
			{
				( read<T*>( L, 1 )->*upvalue_<void(UAPI T::* )( T1 )>( L ) )( read<T1>( L, 2 ) );
				return 0;
			}
        };
    ...
    template<typename T>
        struct mem_functor < void, T >
        {
			...
			static int invokeU( lua_State *L )
			{
				( read<T*>( L, 1 )->*upvalue_<void(UAPI T::* )( )>( L ) )( );
				return 0;
			}
        };
    ...
    template<typename T, typename T1>
        struct mem_functor < int, T, lua_State*, T1 >
        {
			...
			static int invokeU( lua_State *L )
			{
				return ( read<T*>( L, 1 )->*upvalue_<int(UAPI T::* )( lua_State*, T1 )>( L ) )( L, read<T1>( L, 2 ) );
			}
        };
    ...
    template<typename T>
        struct mem_functor < int, T, lua_State* >
        {
			...
			static int invokeU( lua_State *L )
			{
				return( read<T*>( L, 1 )->*upvalue_<int(UAPI T::* )( lua_State* )>( L ) )( L );
			}
        };
    ...
    template<typename T>
        struct class_name
        {
            ...
            static const char* name( const char* name = NULL )
            {
                ...
                if ( name != NULL )
                {
                    strncpy_s( temp, name, sizeof( temp ) - 1 );
                }
