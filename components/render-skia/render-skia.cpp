...
bool String2Bool(LPCWSTR value)
{
	if(*value == 0) return false;
	return !(wcsicmp(value,L"false")==0 || wcsicmp(value,L"0")==0);
}
...
BOOL SRenderTarget_Skia::GetAntiAlias() SCONST
{
	return m_bAntiAlias;
}
...
// SBitmap_Skia
static int s_cBmp = 0;
SBitmap_Skia::SBitmap_Skia( IRenderFactory *pRenderFac ) 
:TSkiaRenderObjImpl<IBitmap,OT_BITMAP>(pRenderFac),m_hBmp(0)
{
...
SkTypeface * SFont_Skia::GetFont() const
{
	return m_skFont;
}

const SkPaint SFont_Skia::GetPaint() const
{
	return m_skPaint;
}
...
{
	return (SOUI::FillType)m_skPath.getFillType();
}
...
{
	return (SOUI::Convexity)m_skPath.getConvexity();
}
