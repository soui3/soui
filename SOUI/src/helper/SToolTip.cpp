...
namespace SOUI
{
    ...
    {
        HWND hWnd=SNativeWnd::CreateWindow(_T("soui tooltip"),WS_POPUP|TTS_NOPREFIX|TTS_ALWAYSTIP,WS_EX_TOOLWINDOW|WS_EX_TOPMOST|WS_EX_NOACTIVATE,0,0,0,0,NULL,NULL);
