...
namespace SOUI
{
    ...
    {
        HWND hWnd=CNativeWnd::Create(_T("soui tooltip"),WS_POPUP|TTS_NOPREFIX|TTS_ALWAYSTIP,WS_EX_TOOLWINDOW|WS_EX_TOPMOST|WS_EX_NOACTIVATE,0,0,0,0,NULL,NULL);
    ...
    {
        CNativeWnd::OnFinalMessage(hWnd);
        delete this;
    }
}//namespace SOUI