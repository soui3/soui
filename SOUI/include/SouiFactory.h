...
public:
	STDMETHOD_(HRESULT,CreateApp)(THIS_ IApplication **ppRet,IRenderFactory *pRenderFac,HMODULE hInst,LPCTSTR pszHostClassName=_T("SOUIHOST"),BOOL bImeApp=FALSE) OVERRIDE;
